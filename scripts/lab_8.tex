...
\hypersetup{unicode=true,
            pdftitle={Lab 8},
            pdfauthor={Lisa Strycker~\& Lisa Strycker},
...
\def\footnote{\protect\rmarkdownfootnote}
  ...
  \title{Lab 8}
    \author{Lisa Strycker\textsuperscript{1}~\& Lisa Strycker\textsuperscript{1,2}}
    \date{}
  
\shorttitle{The papaja file for lab 8}
\affiliation{
\vspace{0.5cm}
\textsuperscript{1} Oregon Research Institute\\\textsuperscript{2} University of Oregon}
...
We report how we determined our sample size, all data exclusions (if any), all manipulations, and all measures in the study. This paper shows how ({\textbf{???}}) used similar procedures (also see {\textbf{???}}).
