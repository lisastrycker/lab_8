...
stardf <- stardf %>%
  janitor::clean_names()
```
Sow bugs and students are a lot alike. They are a bit silly and they eat glucose. This paper explores the research about isopod tonic immobility, and provides a table and a plot about student math and reading scores.
